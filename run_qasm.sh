...
srun --mem=30G python3 -u run_mlqls.py --dt grid --d 7 --qf ../QASMBench/large/swap_test_n41/swap_test_n41_transpiled.qasm &> molsq_log/49_swap_test_n41.out
srun --mem=30G python3 -u run_mlqls.py --dt grid --d 10 --qf ../QASMBench/large/swap_test_n83/swap_test_n83_transpiled.qasm &> molsq_log/100_swap_test_n83.out
...
# srun --mem=30G python3 -u run_mlqls.py --dt grid --d 8 --qf ../QASMBench/large/qft_n63/qft_n63_transpiled.qasm &> molsq_log/64_qft_n63.out

# srun python3 -u run_mlqls.py --dt eagle --qf ../QASMBench/large/adder_n28/adder_n28_transpiled.qasm &> molsq_log/eagle_adder_n28.out
# srun python3 -u run_mlqls.py --dt eagle --qf ../QASMBench/large/knn_n31/knn_n31_transpiled.qasm &> molsq_log/eagle_knn_31.out
...
# srun python3 -u run_mlqls.py --dt eagle --qf ../QASMBench/large/bv_n30/bv_n30_transpiled.qasm &> molsq_log/eagle_bv_30.out
# srun python3 -u run_mlqls.py --dt eagle --qf ../QASMBench/large/swap_test_n41/swap_test_n41_transpiled.qasm &> molsq_log/eagle_swap_test_n41.out
...
# srun python3 -u run_mlqls.py --dt eagle --qf ../QASMBench/large/dnn_n33/dnn_n33_transpiled.qasm &> molsq_log/eagle_dnn_33.out
