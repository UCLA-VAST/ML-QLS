...
class Gate
{
    public:
        ...
        void       setTargetPhysicalQubit(const unsigned_t idx, const unsigned_t phy_q)     { assert(isValidQubitIdx(idx)); _vTargetPhysicalQubit[idx] = phy_q; }
        ...
        vector<unsigned_t> const & vTargetProgramQubit() { return _vTargetProgramQubit; }
        vector<unsigned_t> const & vTargetPhysicalQubit() { return _vTargetPhysicalQubit; }
